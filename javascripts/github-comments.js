    ...
    $.ajax({
        ...
        success: function(comments, textStatus, jqXHR) {
            ...
            if (1 == page_id) {
                ...
                $("#gh-comments-list").append("<form action='" + url + "' rel='nofollow'> <input type='submit' value='أكتب تعليقاً في قيت هب' /> </form>");
            }
        ...
        error: function() {
            $("#gh-comments-list").append("التعليقات مغلقة لهذه التدوينة");
        }
    });
}
